<template>
  <div v-if="Object.keys(itemParams).length !== 0" class="params-wrap">
		<div v-for="(item, index) in itemParams.tables">
		...
		<div v-for="(info, index) in itemParams.set" :key="index" class="flex info-list-wrap">
